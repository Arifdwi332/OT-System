...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
        <div class="image">         
            <img src="{{asset('lte/dist/img/Logo_API.png')}}" alt="API-Logo" class="brand-image" style="opacity: .8; width: 200px; height: auto;">
          </div>
    </div>
    <div class="card-body">
      ...
      <form action="#" method="POST">
        @csrf
          <div class="input-group mb-3">
            <input type="text" class="form-control" name="npk" value="{{ old('npk')}}" placeholder="NPK">
